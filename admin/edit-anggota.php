                                ...
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="update-anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input name="password_old" type="hidden" id="password_old" class="form-control" value="<?php echo $data['password']; ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <input name="foto" id="foto" type="hidden" value="<?php echo $data['foto']; ?>" />
                                        </div>
                                    </div>
